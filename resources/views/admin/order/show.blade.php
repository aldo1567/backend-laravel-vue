                ...
                <div class="card-body">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                {{ $invoice->courier }} / {{ $invoice->service }} / {{ number_format($invoice->cost_courier) }}
                            </td>
                        </tr>
                        <tr>
                                ...
                                <tr style="background: #edf2f7">
                                    <td class="b-none" width="25%">
                                        <div class="wrapper-image-cart">
                                            <img src="{{ $product->image }}" alt="Gambar" style="width: 100%;border-radius: 0.5rem">
                                        </div>
                                    </td>
                                    <td class="b-none" width="50%">
                                        ...
                                        <table class="table-borderless" style="font-size: 14px">
                                            <tr>
                                                <td style="padding: 0.20rem">QTY</td>
                                                <td style="padding: 0.20rem">:</td>
                                                <td style="padding: 0.20rem">{{ $product->qty }}</td>
                                            </tr>
                                        </table>
                                    </td>
